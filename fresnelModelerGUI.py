            ...
            for objectRadius in objectRadiuses:
                for stellarDiameter in stellarDiameters:
                    for shiftAdjustment in shiftAdjustments:
                        ...
                        graphName = str(samplingFrequency) + "Hz_" + str(objectRadius) + "m_" + str(stellarDiameter) + "mas_0m_" + str(shiftAdjustment) + "frames.png"
                        plt.title(graphName)
                        plt.plot(kernel)
            ...
            for objectRadius in objectRadiuses:
                for stellarDiameter in stellarDiameters:
                    for shiftAdjustment in shiftAdjustments:
                        ...
                        plt.xlabel('time (s)')
                        plt.ylabel('fractional intensity')
                        graphName = str(samplingFrequency) + "Hz_" + str(objectRadius) + "m_" + str(stellarDiameter) + "mas_" + str(objectRadius/2) + "m_" + str(shiftAdjustment) + "frames.png"
                        plt.title(graphName)
                        plt.plot(kernel)
                        path = "kernel_images/" + graphName
                        plt.savefig(path)
            ...
            for objectRadius in objectRadiuses:
                for stellarDiameter in stellarDiameters:
                    for shiftAdjustment in shiftAdjustments:
                        ...
                        plt.xlabel('time (s)')
                        plt.ylabel('fractional intensity')
                        graphName = str(samplingFrequency) + "Hz_" + str(objectRadius) + "m_" + str(stellarDiameter) + "mas_" + str(objectRadius) + "m_" + str(shiftAdjustment) + "frames.png"
                        plt.title(graphName)
                        plt.plot(kernel)
                        path = "kernel_images/" + graphName
                        plt.savefig(path)
            ...
            for objectRadius in objectRadiuses:
                for stellarDiameter in stellarDiameters:
                    for shiftAdjustment in shiftAdjustments:
                        ...
                        plt.xlabel('time (s)')
                        plt.ylabel('fractional intensity')
                        graphName = str(samplingFrequency) + "Hz_" + str(objectRadius) + "m_" + str(stellarDiameter) + "mas_" + str(objectRadius * edit_impact_factor) + "m_" + str(shiftAdjustment) + "frames.png"
                        plt.title(graphName)
                        plt.plot(kernel)
                        path = "kernel_images/" + graphName
                        plt.savefig(path)
